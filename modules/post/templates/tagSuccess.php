<?php use_helper('Date') ?>
<?php slot('title', sprintf('Voir tous les articles avec le tag %s', $sf_request->getParameter('categoryName'))); ?>
...
<?php
  ...
  {
    echo sprintf('Il n\'y a aucun article dans la catégégorie %s', $sf_request->getParameter('categoryName'));
  }
?>